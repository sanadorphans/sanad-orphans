...
<html dir="rtl" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="container-all active">
                ...
                <div class="formBx active">
                    ...
                    <div class="form signup-form">
                        ...
                        <form method="POST" action="{{ route('users.categorize') }}">
                            ...
                            <div class="d-flex align-items-center justify-content-center pb-2 my-3">
                                <div class="form-check text-center d-flex flex-column px-3">
                                    <div>
                                ...
                                <div class="form-check text-center d-flex flex-column px-4">
                                    <div>
