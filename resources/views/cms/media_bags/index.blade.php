...
@section('header_tags')
    <title>{{ __('lang.media_bags') }} | {{ __('lang.wataneya') }}</title>
    <meta itemprop="name" content="{{ __('lang.media_bags') }} | {{ __('lang.wataneya') }}">
    ...
    <meta property="og:title" content="{{ __('lang.media_bags') }} | {{ __('lang.wataneya') }}">
    ...
    <meta name="twitter:title" content="{{ __('lang.media_bags') }} | {{ __('lang.wataneya') }}">
            ...
            <div class="col-xs-12 d-flex remove-padding team-main mt-4">
                @forelse($bags as $bag)
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <a href="{{ $bag->link }}" class="new-item pro-item">
                            <div class="img-frame">
                                <img src="{{ asset('storage/' . $bag->image) }}" alt="{{ $bag->$title }}">
                            </div>
