...
@section('header_tags')
    <title>{{ __('lang.technical_reports') }} | {{ __('lang.wataneya') }}</title>
    <meta itemprop="name" content="{{ __('lang.technical_reports') }} | {{ __('lang.wataneya') }}">
    ...
    <meta property="og:title" content="{{ __('lang.technical_reports') }} | {{ __('lang.wataneya') }}">
    ...
    <meta name="twitter:title" content="{{ __('lang.technical_reports') }} | {{ __('lang.wataneya') }}">
            ...
            <div class="col-xs-12 d-flex remove-padding team-main mt-4">
                @forelse($reports as $report)
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <a href="{{ $report->link }}" class="new-item pro-item">
                            <div class="img-frame">
