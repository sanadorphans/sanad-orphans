...
<head>
    ...
    <script id="mcjs">!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.async=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/25ba645f10169963cf352dcf8/621ab03d0665c883a70ea203e.js");</script>
    ...
    <meta name="is_rtl" content="true">
        <meta http-equiv="Cache-control" content="public" max-age=31536000>
        <title>اتصل الآن | وطنية</title>
    <meta content="منذ نشأتها في 2008، تعمل وطنية على تطوير جميع محاور الرعاية البديلة من أجل حياة كريمة لكل يتيم." name="description" />
    <!-- Google / Search Engine Tags -->
    <meta itemprop="name" content="الرئيسية | وطنية">
    <meta itemprop="description" content="منذ نشأتها في 2008، تعمل وطنية على تطوير جميع محاور الرعاية البديلة من أجل حياة كريمة لكل يتيم.">
    ...
    <meta property="og:description" content="منذ نشأتها في 2008، تعمل وطنية على تطوير جميع محاور الرعاية البديلة من أجل حياة كريمة لكل يتيم.">
    ...
    <meta name="twitter:description" content="منذ نشأتها في 2008، تعمل وطنية على تطوير جميع محاور الرعاية البديلة من أجل حياة كريمة لكل يتيم.">
    ...
    <link href="https://wataneya.org/assets/web/css/bootstrap2.css" rel="stylesheet">
    <link href="https://wataneya.org/assets/web/css/donation-p.css"  rel="stylesheet">
    <link href="https://wataneya.org/assets/web/css/style.css"  rel="stylesheet">
            <link href="https://wataneya.org/assets/web/css/bootstrap-rtl.css" rel="stylesheet">
        <link href="https://wataneya.org/assets/web/css/chosen.min.css"  rel="stylesheet">
    <link href="https://wataneya.org/assets/web/css/jquery-ui.css" rel="stylesheet">
    <link href="https://wataneya.org/assets/web/css/slick.css" rel="stylesheet">
    <link href="https://wataneya.org/assets/web/css/slick-themes.css" rel="stylesheet">
            <link href="https://wataneya.org/assets/web/css/style-ar.css"  rel="stylesheet">
        <link href="https://wataneya.org/assets/web/css/footer-ar.css"  rel="stylesheet">
        <style>
        .search .submit{
           left:4px;
        }
        </style>
        <link rel="icon" href="https://www.wataneya.org/assets/defaults/icon/icon.png" />
    <link href="https://wataneya.org/assets/web/customs/css/style.css" rel="stylesheet"/>
            <style>
...
.message .fail{
    ...
    " class="searchBar">
        <input type="hidden" name="_token" value="t7qbBV9gMdWKZCn01ftf8Egyi2hFgEU6dNdNDPxY">        <div class="search">
    ...
    <div class="container remove-padding">
        ...
        <div class="col-md-4 lan-main col-sm-4">
            ...
            "><img src="https://wataneya.org/storage/media/photos/shares/62c059dbded47.svg" width="20px" height="20px" alt="search"></button>
                                                                            <a href="https://wataneya.org/en/contact-us">
                        English
                    </a>
                                    </div>
    </div>
    ...
    <div class="container remove-padding">
        ...
        <div class="col-md-2 col-xs-12 logo-main">
            <a href="https://wataneya.org/ar">
                <img src="https://www.wataneya.org/assets/defaults/logo/logo.png" class="img-responsive"
    ...
    <div class="container-fluid remove-padding cont-main">
        <div class="container remove-padding">
            <div class="col-xs-12 site-map">
                <ul>
                    <li>
                        <a href="https://wataneya.org/ar">الرئيسية</a>
                    </li>
                    <li><p>اتصل الآن</p></li>
                </ul>
            </div>
            ...
            <div class="col-md-8 col-md-offset-2 col-xs-12 col-sm-12 contact-main">
                <form method="POST" action="https://wataneya.org/ar/contact-us"
                      accept-charset="UTF-8">
                    <input type="hidden" name="_token" value="t7qbBV9gMdWKZCn01ftf8Egyi2hFgEU6dNdNDPxY">                    <div class="col-xs-12 remove-padding input-main has-feedback ">
                        <p>الاسم</p>
                    ...
                    <div class="col-xs-12 remove-padding input-main has-feedback ">
                        ...
                        <input type="email" class="form-control" placeholder="البريد الإلكترونى" name="email"
                               id="email" value="">
                                            </div>
                    ...
                    <div class="col-xs-12 remove-padding input-main has-feedback ">
                        <p>الرسالة</p>
                        <textarea name="message" id="message" placeholder="الرسالة" cols="10" rows="10"
                                  class="form-control"></textarea>
                                            </div>

                    <button type="submit" class="solid-btn">ارسال</button>
                </form>

                <div class="col-xs-12 remove-padding map-main">
                    <h4>الموقع الجغرافى</h4>
                    <p> 3 شارع البيروني بجوار قصر البارون - مصر الجديدة - القاهرة </p>
                                                                    <span class="details"><div id="map"></div>
</span>
                                        ...
                                        <a href="https://twitter.com/WataneyaSociety" target="_blank"
                                           title="تطبيق التويتر">
                                            <i class="fa fa-twitter"></i>
                                                                    ...
                                                                    <li>
                                        <a href="https://www.youtube.com/user/amaaner" target="_blank"
                                           title="Youtube">
                                            <i class="fa fa-youtube"></i>
                                        </a>
                                    </li>
...
<!--End mc_embed_signup-->
        ...
        <div class="map col-md-3">
            ...
            <!--    <li style="color:white;">info@wataneya.org</li>-->
            <!--</ul>-->
            <ul class="support">                       
